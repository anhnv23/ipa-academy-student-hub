...
Phiên bản 1.2.0: tài khoản Admin mặc định `Admin / Admin@123` được tự động đồng bộ với Supabase khi đăng nhập trên Netlify. Tài khoản học viên và giáo viên do Admin tạo được lưu trong Supabase.
